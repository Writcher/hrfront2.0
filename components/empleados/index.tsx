...
import { getProyectos } from "@/actions/proyecto/proyecto.actions";
import { getTiposEmpleado } from "@/actions/tipoEmpleado/tipoEmpleado.actions";
import { getModalidadesValidacion } from "@/actions/modalidadValidacion/modalidadValidacion.actions";
import { getEmpleados } from "@/actions/empleado/empleado.actions";
import { syncEmpleados } from "@/actions/features/sync/sync.actions";
...
export default function Empleados({ esAdministrativo }: { esAdministrativo?: boolean }) {
    //hooks
        ...
        <div className='flex flex-col gap-2 w-full h-full overflow-hidden'>
            ...
            <ActiveFilters
                ...
                filters={[
                    ...
                    { key: 'id_proyecto', variant: 'select', util: getNombreById(proyectos.data ? proyectos.data : []) },
                    { key: 'id_tipoempleado', variant: 'select', util: getNombreById(tiposEmpleado.data ? tiposEmpleado.data : []) }
                ]}
            />
            {/** Tabla */}
                        ...
                        skeleton={
                            <TableSkeleton
                                ...
                                columns={[
                                    ...
                                    { variant: 'text', alignment: 'center', colWidth: '15%', width: 100 },
                                    { variant: 'rectangular', alignment: 'center', colWidth: '10%', width: 60 },
                                    { variant: 'rectangular', alignment: 'right', colWidth: '10%', width: 60, count: 2 }
                                ]}
                            />
                        }
                        body={
